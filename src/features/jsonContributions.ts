...
export interface IJSONContribution {
	...
	getInfoContribution(fileName: string, location: Location): Promise<MarkedString[] | null> | null;
	collectPropertySuggestions(fileName: string, location: Location, currentWord: string, addValue: boolean, isLast: boolean, result: ISuggestionsCollector): Promise<any> | null;
	collectValueSuggestions(fileName: string, location: Location, result: ISuggestionsCollector): Promise<any>;
	collectDefaultSuggestions(fileName: string, result: ISuggestionsCollector): Promise<null>;
	resolveSuggestion?(item: CompletionItem): Promise<CompletionItem | null> | null;
}
